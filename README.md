# base-wallet-exporter

Export Base wallet data to CSV using user input.
...
```bash
git clone https://github.com/YOUR_GITHUB_USERNAME/base-wallet-exporter.git
cd base-wallet-exporter
python3 -m venv .venv
